...
public:
    ...
    void start() {
        ...
        for (const string& word : words) {
            ...
            int countdown = 10 - duration;
            cout << "\t\t\t\t\t\t\t\t Time left: " << countdown << endl;
...
private:
    ...
    int lives;
    int highScore;
    int timeLimit; // added member variable for time limit
...
public:
    ZtypeGame() {
        ...
        lives = 5;
        highScore = readHighScore();
        timeLimit = 10; // set time limit to 10 seconds
    }
    ...
    void start() {
        ...
        for (const string& word : words) {
            ...
            if (duration >= timeLimit) { // if time is up
                cout << "\t\t\t\t\t\t\t\t Time's up!" << endl;
                lives--;
            }
            else if (entered_input) {
